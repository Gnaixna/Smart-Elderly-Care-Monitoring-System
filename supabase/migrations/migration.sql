...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:mptv8/gh3t9q3fSYAlqaaA==$OURbNteGe7s1Y25k2lCIFJsa7UiaVBoADSZX7BctK08=:i4/813l6+MqQzjfY516BT3x9gsMfH+hHSjIkaY5JQu8=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:TERDanZiiyuLG0fwZodCYQ==$dJdrXqwF+78krnHP+2CRPzJiF7V5GY3KYCovPfh9Qno=:6MgjY21H6YlCIO8TKuDilusdouvZstOWm9Hl2XsS8eg=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:1qUzNKq5gfGQI/a+8fNfQQ==$Q5IE3xiBQZAFkctpt0U4kmMz3EwXggOlO1isQG843CU=:QXO/euMed4W9ZQTKR2sBBSgjdVII2yKP7EkAoZCBNoo=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ebBDly7vKz+HDdXxNrCYZQ==$ntQMN+O2NKP1LKQY2OnRC2D0r0qHfSOgSvsvOcxnPYk=:QZUxwPYjR8THPv6ZIBjofGFPrI3tsf21Nhrp3P5TQDE=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:tWGrns/m7WhLJTFgVkf6Xw==$fSsKEunzD9M38fKO0P+/OQcjsLQy5KHTZm45KOYS+PA=:MQUzRTDZmGw/tNhC/SXfO8RZjwW4uhpMhURWrYvFF/0=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ImL4GyrX98grpP5oK18iXg==$XYnNJqzV3IkW076p9k9BDH+2zcdTJxoOCPfNxwrLEgs=:ATvvv2obJu7JG13+xyjrE0HtQGwaOPLKUGVAGSEwoJU=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:q30XXU9lNwxWZbNZSH5CsA==$lE3IxXQa0QcfLQiSXJ9TFyjd3uSMPh57E+uSTU7lEEM=:TaExprY8wdEAMQRe8IItYfnOl8VYRVMUp8kjPWCcbPA=';
...
CREATE FUNCTION "public"."handle_new_user"() RETURNS "trigger"
    ...
    AS $$
BEGIN
  INSERT INTO public.profiles (id, phone, role, openid, username)
  VALUES (
    NEW.id,
    NEW.phone,
...
--
-- Name: alarm_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."alarm_records" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "device_id" "text" DEFAULT 'device-001'::"text" NOT NULL,
    "alarm_type" "text" NOT NULL,
    "alarm_value" "text",
    "alarm_level" "text" DEFAULT 'medium'::"text" NOT NULL,
...
CREATE TABLE "public"."devices" (
    "id" "text" DEFAULT 'device-001'::"text" NOT NULL,
    "name" "text" DEFAULT '老人监护设备001'::"text" NOT NULL,
    "is_online" boolean DEFAULT true NOT NULL,
    "last_seen_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "product_key" "text",
    "device_name_iot" "text",
    "connect_status" "text" DEFAULT 'unknown'::"text",
    "last_connected_at" timestamp with time zone
);


--
-- Name: COLUMN "devices"."product_key"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."devices"."product_key" IS '阿里云 IoT 产品 ProductKey';


--
-- Name: COLUMN "devices"."device_name_iot"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."devices"."device_name_iot" IS '阿里云 IoT 设备 DeviceName';


--
-- Name: COLUMN "devices"."connect_status"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."devices"."connect_status" IS '连接状态: unknown / connected / failed';


--
-- Name: COLUMN "devices"."last_connected_at"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."devices"."last_connected_at" IS '最后一次连接成功时间';
...
CREATE TABLE "public"."health_records" (
    ...
    "fall_detected" boolean DEFAULT false NOT NULL,
    "smoke_value" numeric(6,2),
    "smoke_alarm" boolean DEFAULT false NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
CREATE TABLE "public"."profiles" (
    ...
    "openid" "text",
    "heart_rate_max" integer DEFAULT 110 NOT NULL,
    "heart_rate_min" integer DEFAULT 50 NOT NULL,
    "blood_oxygen_min" integer DEFAULT 92 NOT NULL,
    "temperature_max" numeric(4,1) DEFAULT 37.5 NOT NULL,
    "temperature_min" numeric(4,1) DEFAULT 36.0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
--
-- Name: alarm_records alarm_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."alarm_records"
    ADD CONSTRAINT "alarm_records_pkey" PRIMARY KEY ("id");
...
--
-- Name: profiles admins_full_access_profiles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "admins_full_access_profiles" ON "public"."profiles" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: alarm_records; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."alarm_records" ENABLE ROW LEVEL SECURITY;

--
-- Name: alarm_records authenticated_insert_alarm; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "authenticated_insert_alarm" ON "public"."alarm_records" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: health_records authenticated_insert_health; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "authenticated_insert_health" ON "public"."health_records" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: alarm_records authenticated_read_alarm; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "authenticated_read_alarm" ON "public"."alarm_records" FOR SELECT TO "authenticated" USING (true);


--
-- Name: devices authenticated_read_devices; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: health_records authenticated_read_health; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "authenticated_read_health" ON "public"."health_records" FOR SELECT TO "authenticated" USING (true);


--
-- Name: alarm_records authenticated_update_alarm; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "authenticated_update_alarm" ON "public"."alarm_records" FOR UPDATE TO "authenticated" USING (true);


--
-- Name: devices authenticated_update_devices; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "authenticated_update_devices" ON "public"."devices" FOR UPDATE TO "authenticated" USING (true);
